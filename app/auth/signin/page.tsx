  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-6">
      ...
      <button
        ...
        className="flex items-center gap-3 px-6 py-3 bg-white hover:bg-gray-100 text-gray-900 rounded-xl font-medium transition-all shadow-lg"
      >
      ...
      <p className="mt-6 text-xs text-slate-500 text-center max-w-sm">
        This grants access to Vertex AI for enhanced image generation.
